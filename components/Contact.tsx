          ...
          <div>
            ...
            >
              <div>
                ...
                <input
                  ...
                  style={{ backgroundColor: '#D9D9D9', color: '#717171', borderRadius: '5px' }}
                />
              </div>
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                style={{ resize: 'none', backgroundColor: '#D9D9D9', color: '#717171', borderRadius: '5px' }}
              />
            </div>
